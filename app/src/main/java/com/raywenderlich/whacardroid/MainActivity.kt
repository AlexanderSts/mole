...
import com.raywenderlich.whacardroid.DroidPosition.*
    ...
    arFragment.setOnTapArPlaneListener { hitResult: HitResult, plane: Plane, _: MotionEvent ->
      ...
      TranslatableNode()
          .also {
            ...
            it.addOffset(x = - spacing/2, y = 0F, z = spacing*3/2)
            var localRotation = Quaternion();
            localRotation.set(-1F,0F,0F,0.96F)
            it.localRotation=localRotation
          }
